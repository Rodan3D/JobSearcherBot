...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def test_add_keyword_stat(self, mock_session):
        mock_session.query.return_value.filter_by.return_value.first.\
            return_value = None
        database_manager.add_keyword_stat('test_keyword', 3)
    ...
    def test_add_excluded_word_stat(self, mock_session):
        mock_session.query.return_value.filter_by.return_value.first.\
            return_value = None
        database_manager.add_excluded_word_stat('test_excluded_word', 2)
        mock_session.add.assert_called_once()
        mock_session.commit.assert_called_once()
    ...
    def test_get_popular_keywords_from_database(self, mock_session):
        ...
        popular_keywords = \
            database_manager.get_popular_keywords_from_database()
    ...
    def test_get_popular_excluded_words_from_database(self, mock_session):
        ...
        popular_excluded_words = \
            database_manager.get_popular_excluded_words_from_database()
        self.assertEqual(popular_excluded_words, ['excluded_word1', 
                                                  'excluded_word2'])
    ...
    def test_add_keyword_stat_existing_keyword(self, mock_session):
        ...
        database_manager.add_keyword_stat('existing_keyword', 3)
    ...
    def test_add_excluded_word_stat_existing_word(self, mock_session):
        ...
        database_manager.add_excluded_word_stat('existing_word', 2)
    ...
    def test_get_popular_keywords_from_empty_database(self, mock_session):
        mock_query = mock_session.query.return_value
        mock_query.order_by.return_value.limit.return_value = []
        popular_keywords = database_manager.\
    ...
    def test_get_popular_excluded_words_from_empty_database(self, mock_session):
        mock_query = mock_session.query.return_value
        mock_query.order_by.return_value.limit.return_value = []
        popular_excluded_words = database_manager.\
    ...
    def test_add_keyword_stat_new_keyword(self, mock_session):
        mock_session.query.return_value.filter_by.return_value.first.\
            return_value = None
        database_manager.add_keyword_stat('new_keyword', 4)
        mock_session.add.assert_called_once()
        mock_session.commit.assert_called_once()
    ...
    def test_add_excluded_word_stat_new_word(self, mock_session):
        mock_session.query.return_value.filter_by.return_value.first.\
            return_value = None
        database_manager.add_excluded_word_stat('new_word', 3)
        mock_session.add.assert_called_once()
        mock_session.commit.assert_called_once()
